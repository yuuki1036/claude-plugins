...
- **Phase 5.5 Adaptive deepening**: reviewer の `unmet_information` 申告をトリガーに追加 explorer ラウンドを 1 回起動して該当 reviewer を再実行
...
| `enable_adaptive_rounds` | `true` | Phase 5.5 追加 explorer ラウンドの有効化 |

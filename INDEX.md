...
| [code-review](#code-review) | 2.115.0 | 2 | 2 | - | SessionStart, Stop | - | Phase 0 トリアージ + 動的構成コードレビュー |
| [design-doc](#design-doc) | 0.4.7 | 2 | 2 | 1 | - | - | 技術設計書を実装に入らず作成・永続化 + 4視点レビュー |
| [dev-workflow](#dev-workflow) | 1.27.3 | 4 | 6 | - | Pre/PostToolUse, SessionStart | ✓ | Git コミット・PR・UI 確認・バグ診断・worktree |

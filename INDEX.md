...
| [code-review](#code-review) | 2.94.1 | 2 | 2 | - | SessionStart | - | Phase 0 トリアージ + 動的構成コードレビュー |
...
| [guardrail-protect](#guardrail-protect) | 0.4.1 | - | - | - | PreToolUse | - | 設定骨抜き・--no-verify・実在しない見出し参照を機械ブロック |

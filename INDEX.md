...
| [claude-meta](#claude-meta) | 1.13.1 | 2 | 5 | - | - | - | CC 設定管理・CLAUDE.md 監査・eval 回帰 |
...
| [issue-workflow](#issue-workflow) | 1.3.1 | 13 | 13 | 4 | 5 events | - | Issue 管理（linear/indie 統合後継・backend 自動判定） |

...
| [code-review](#code-review) | 2.126.2 | 4 | 4 | - | SessionStart, Stop, PreToolUse | - | Phase 0 トリアージ + 動的構成コードレビュー |
...
- **commands**: `review`, `self-review`, `comment-polish`, `review-triage`
- **skills**: `review`, `self-review`, `comment-polish`, `review-triage`

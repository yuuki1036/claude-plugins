...
| [code-review](#code-review) | 2.35.0 | 2 | 2 | - | SessionStart | - | Phase 0 トリアージ + 動的構成コードレビュー |
...
| [spec-advisor](#spec-advisor) | 0.1.2 | 1 | 1 | - | SessionStart | - | 開発タスクから設計・計画系 spec をルーティング提案 |

...
| [code-review](#code-review) | 2.124.0 | 3 | 3 | - | SessionStart, Stop, PreToolUse | - | Phase 0 トリアージ + 動的構成コードレビュー |
...
| [feature-dev](#feature-dev) | 2.14.0 | 1 | 1 | 2 | SessionStart | - | 8 phase 機能開発ワークフロー |
...
- **commands**: `review`, `self-review`, `comment-polish`
- **skills**: `review`, `self-review`, `comment-polish`

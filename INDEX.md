...
|-----------|---------|----:|------:|-------|-------|-----|------|
| [adr-keeper](#adr-keeper) | 0.2.1 | 1 | 1 | - | - | - | 設計判断 (ADR) を append-only 蓄積 |
...
| [failure-journal](#failure-journal) | 0.3.0 | 2 | 2 | - | SessionStart, PostCompact | - | 再発失敗の fingerprint 集計・retro 還流 |
...
| [indie-workflow](#indie-workflow) | 1.40.4 | 11 | 11 | 3 | 5 events | - | 個人開発向けローカル Issue 管理 |

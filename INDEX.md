...
| [dev-workflow](#dev-workflow) | 1.26.0 | 4 | 6 | - | Pre/PostToolUse, SessionStart | ✓ | Git コミット・PR・UI 確認・バグ診断・worktree |
...
| [issue-workflow](#issue-workflow) | 1.4.3 | 13 | 13 | 4 | 5 events | - | Issue 管理（linear/indie 統合後継・backend 自動判定） |

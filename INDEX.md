...
|-----------|---------|----:|------:|-------|-------|-----|------|
| [adr-keeper](#adr-keeper) | 0.3.2 | 1 | 1 | - | - | - | 設計判断 (ADR) を append-only 蓄積 |
...
| [dev-workflow](#dev-workflow) | 1.33.1 | 4 | 7 | - | Pre/PostToolUse, SessionStart | ✓ | Git コミット・PR・UI 確認・バグ診断・worktree |
...
| [feature-dev](#feature-dev) | 2.15.1 | 1 | 1 | 2 | SessionStart | - | 8 phase 機能開発ワークフロー |
| [guardrail-protect](#guardrail-protect) | 0.5.2 | - | - | - | PreToolUse | - | 設定骨抜き・--no-verify・実在しない見出し参照・隔離なしの hook 実行を機械ブロック |
| [issue-workflow](#issue-workflow) | 1.6.1 | 13 | 13 | 4 | 5 events | - | Issue 管理（linear/indie 統合後継・backend 自動判定） |

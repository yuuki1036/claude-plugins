...
|-----------|---------|----:|------:|-------|-------|-----|------|
| [adr-keeper](#adr-keeper) | 0.3.3 | 1 | 1 | - | - | - | 設計判断 (ADR) を append-only 蓄積 |
| [bdd-spec](#bdd-spec) | 0.3.4 | 2 | 2 | - | - | - | BDD spec 駆動の scaffold + 5 観点評価 |
| [claude-meta](#claude-meta) | 1.13.7 | 2 | 5 | - | - | - | CC 設定管理・CLAUDE.md 監査・eval 回帰 |
| [code-review](#code-review) | 2.129.2 | 5 | 5 | - | SessionStart, Stop, PreToolUse | - | Phase 0 トリアージ + 動的構成コードレビュー |
| [design-doc](#design-doc) | 0.5.0 | 2 | 2 | 1 | - | - | 技術設計書を実装に入らず作成・永続化 + 4視点レビュー |
| [dev-workflow](#dev-workflow) | 1.34.2 | 4 | 7 | - | Pre/PostToolUse, SessionStart | ✓ | Git コミット・PR・UI 確認・バグ診断・worktree |
...
| [feature-dev](#feature-dev) | 2.16.0 | 1 | 1 | 2 | SessionStart | - | 8 phase 機能開発ワークフロー |
| [guardrail-protect](#guardrail-protect) | 0.5.2 | - | - | - | PreToolUse | - | 設定骨抜き・--no-verify・実在しない見出し参照・隔離なしの hook 実行を機械ブロック |
| [issue-workflow](#issue-workflow) | 1.7.0 | 13 | 13 | 4 | 5 events | - | Issue 管理（linear/indie 統合後継・backend 自動判定） |
| [living-spec-workflow](#living-spec-workflow) | 0.4.1 | 2 | 2 | - | - | - | Issue 化前の設計収束ドキュメントを append-only 運用 |
